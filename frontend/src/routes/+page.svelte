<script lang="ts">
  ...
  $inspect(shouldShowTestnet, metricsData?.networks.supported, filteredNetworks)
</script>
      ...
      {#each floatingImages as image}
        <div
          ...
          style="
					...
					left: {image.direction === 1 ? `-${image.startPos}px` : `${image.startPos}vw`};
					opacity: 0;
    ...
    <div class="relative flex-1 z-20">
      <div class="mx-auto space-y-8">
        ...
        <section class="relative space-y-6 overflow-hidden rounded-lg py-8">
          ...
          <div
            class="mx-auto max-w-3xl text-xl font-light text-gray-600 dark:text-gray-400 text-center flex flex-col gap-2">
              ...
              {#each features as feature}
                <div
                  ...
                  <div class="relative">
                    ...
                    <i
                      class="fas {feature.icon} mb-4 text-4xl text-[#00DC82] transition-transform group-hover:scale-110"
                    ></i>
                ...
                <div class="mb-4 flex justify-end">
                  <label class="group flex cursor-pointer items-center gap-3">
                    <div class="relative">
                      ...
                      <div
                        class="h-6 w-11 rounded-full bg-surface-700/20 transition-colors peer-checked:bg-[#00DC82]/20"
                      ></div>
                      <div
