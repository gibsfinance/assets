...
declare module '$env/static/private' {
	...
	export const npm_package_config_maxsockets: string;
	export const PGPORT: string;
	export const COMMAND_MODE: string;
	export const npm_config_globalconfig: string;
	export const CARGO_TARGET: string;
	...
	export const FOUNDRY_DISABLE_NIGHTLY_WARNING: string;
	...
	export const NIXPKGS_ALLOW_UNSUPPORTED_SYSTEM: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		CGO_LDFLAGS: string;
		USER: string;
		npm_package_config_maxsockets: string;
		PGPORT: string;
		COMMAND_MODE: string;
		...
		FOUNDRY_DISABLE_NIGHTLY_WARNING: string;
		SHLVL: string;
		HOME: string;
		...
		NIXPKGS_ALLOW_UNSUPPORTED_SYSTEM: string;
		GOPATH: string;
